...
// Hover effects
const hoverTargets = document.querySelectorAll('a, button, .fleet-benefit-card, .fleet-package-card, .fleet-faq-question');
...
// =========================================
// VAN SHOWCASE — SCROLL-DRIVEN ANIMATION
// =========================================
(function () {
    const section = document.getElementById('fleet-showcase');
    if (!section) return;
    ...
    function updateShowcase() {
        ...
        // Phase 1: Van reveal (0% - 25%) — starts partially visible, no black gap
...
// FAQ ACCORDION
// =========================================
const faqItems = document.querySelectorAll('.fleet-faq-item');

faqItems.forEach(item => {
    const btn = item.querySelector('.fleet-faq-question');
